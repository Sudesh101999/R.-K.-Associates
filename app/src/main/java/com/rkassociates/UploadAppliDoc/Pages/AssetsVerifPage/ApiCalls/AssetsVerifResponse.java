...
public class AssetsVerifResponse {
    ...
    private int status;
    private String msg;
    private int assetsVerification;
    ...
    public int getAssetsVerification() {
        return assetsVerification;
    }

    public void setAssetsVerification(int assetsVerification) {
        this.assetsVerification = assetsVerification;
    }
}
